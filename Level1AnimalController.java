...
public class Level1AnimalController {
    ...
    @FXML
    private Button button_quit_A1;

    @FXML
    private Label label_time;

    @FXML
    private ImageView Imageview_soundON_A1;

    @FXML
    private ImageView Imageview_soundOFF_A1;
    ...
    @FXML
    void button_quitA1_action(ActionEvent event) {
        try {
            if (backgroundMusic != null) {
                backgroundMusic.stop();
            }
            Stage stage = (Stage) button_quit_A1.getScene().getWindow();
    ...
    @FXML
    void Imageview_soundON_A1_action(MouseEvent event) {
        Imageview_soundON_A1.setVisible(false);
        Imageview_soundOFF_A1.setVisible(true);
    ...
    @FXML
    void Imageview_soundOFF_A1_action(MouseEvent event) {
        Imageview_soundON_A1.setVisible(true);
        Imageview_soundOFF_A1.setVisible(false);
