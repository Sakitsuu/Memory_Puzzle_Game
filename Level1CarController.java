...
public class Level1CarController {
    ...
    @FXML
    private Button button_quit_C1;

    @FXML
    private Label label_time;

    @FXML
    private ImageView Imageview_soundON_C1;

    @FXML
    private ImageView Imageview_soundOFF_C1;
    ...
    CarImageNames.add(name);
        ...
        List<String> selected = CarImageNames.size() >= 6 ? CarImageNames.subList(0, 6) : CarImageNames;
    ...
    @FXML
    void button_quitC1_action(ActionEvent event) {
        try {
            if (backgroundMusic != null) {
                backgroundMusic.stop();
            }
            Stage stage = (Stage) button_quit_C1.getScene().getWindow();
    ...
    @FXML
    void Imageview_soundON_C1_action(MouseEvent event) {
        Imageview_soundON_C1.setVisible(false);
        Imageview_soundOFF_C1.setVisible(true);
    ...
    @FXML
    void Imageview_soundOFF_C1_action(MouseEvent event) {
        Imageview_soundON_C1.setVisible(true);
        Imageview_soundOFF_C1.setVisible(false);
