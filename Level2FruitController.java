...
public class Level2FruitController {
    ...
    @FXML
    private Button button_quit_F2;

    @FXML
    private Label label_time;

    @FXML
    private ImageView Imageview_soundON_F2;

    @FXML
    private ImageView Imageview_soundOFF_F2;
    ...
    public void initialize() {
        ...
        // Get all unique fruit image names (ignore Blank.jpg and *Copy.jpg)
    ...
    fruitImageNames.add(name);
        ...
        List<String> selected = fruitImageNames.size() >= 10 ? fruitImageNames.subList(0, 10) : fruitImageNames;
    ...
    @FXML
    void button_quit_F2_action(ActionEvent event) {
        try {
            if (backgroundMusic != null) {
                backgroundMusic.stop();
            }
            Stage stage = (Stage) button_quit_F2.getScene().getWindow();
    ...
    @FXML
    void Imageview_soundON_F2_action(MouseEvent event) {
        Imageview_soundON_F2.setVisible(false);
        Imageview_soundOFF_F2.setVisible(true);
    ...
    @FXML
    void Imageview_soundOFF_F2_action(MouseEvent event) {
        Imageview_soundON_F2.setVisible(true);
        Imageview_soundOFF_F2.setVisible(false);
